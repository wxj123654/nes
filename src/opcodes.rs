...
lazy_static! {
  pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
      ...
      // BIT
      OpCode::new(0x24, "LDA", 2, 3, AddressingMode::ZeroPage),
      OpCode::new(0x2C, "LDA", 3, 4, AddressingMode::Absolute),
    ...
    //   OpCode::new(0x00, "BRK", 1, 7, AddressingMode::NoneAddressing),
      ...
      OpCode::new(0xB9, "CMP", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y),
      OpCode::new(0xA1, "CMP", 2, 6, AddressingMode::Indirect_X),
      OpCode::new(0xB1, "CMP", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y),
      ...
      OpCode::new(0xDE, "DEC", 3, 7/*+1 if page crossed*/, AddressingMode::Absolute_X),
      ...
      // INC
      OpCode::new(0xE6, "EOR", 2, 5, AddressingMode::ZeroPage),
      OpCode::new(0xF6, "EOR", 2, 6, AddressingMode::ZeroPage_X),
      OpCode::new(0xEE, "EOR", 3, 6, AddressingMode::Absolute),
      OpCode::new(0xFE, "EOR", 3, 7/*+1 if page crossed*/, AddressingMode::Absolute_X),
      ...
      OpCode::new(0x5E, "LSR", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X),
      ...
      // RTS
      OpCode::new(0x60, "RTS", 1, 4, AddressingMode::Implied),
